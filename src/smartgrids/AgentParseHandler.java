...
public class AgentParseHandler extends DefaultHandler
{
	...
	{
		final ActorSystem system = ActorSystem.create(name + "System", ConfigFactory.load("agt1conf"));
		id.setActorRef(system.actorOf(Props.create(Agent.class, id, domains, variables, relations, constraints, neighbors), name));
	}
